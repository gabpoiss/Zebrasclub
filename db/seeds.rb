...
Item.create(category_id: 2, size: "large", stock: 2, price: 20000, brand: "CCM", description: "A helmet we recommend for beginners", picture: "../../assets/images/ccm-hockey-helmet-resistance-inset3.jpg")
